<template>
  <section id="searchExcerptsWrapper">
    <ScreenHeader layout="collapsed">
      <span v-if="q">À la recherche de <span class="text-thin">{{ q }}</span></span>
    ...
    <div ref="wrapper" class="main-scroll-wrap">
      ...
      <ScreenEmptyState v-else>
        ...
        Trouvez des sermons, des prédicateurs et des albums,
        <span class="secondary d-block">le tout en un seul endroit.</span>
      </ScreenEmptyState>
    </div>
  </section>
</template>
